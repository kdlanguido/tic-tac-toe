...
export default function Board() {
    ...
    const { board, gameWinner, isGameOver } = useSelector((state: RootState) => state.app)
    ...
    return (
        <div className="flex flex-col">
            ...
            <div className={`grid grid-cols-3 bg-primary h-max m-auto ${isGameOver ? 'mt-10' : null} gap-0 `}>
                {board.map((tile) => (
